...
#    Updated: 2023/04/13 16:08:51 by takra            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCSORTING= $(SORTINGPATH)../algo_sorting.c $(SORTINGPATH)circular_list.c $(SORTINGPATH)del.c \
			...
			$(SORTINGPATH)index_of_list_max.c $(SORTINGPATH)is_circular_sorted.c \
			$(SORTINGPATH)is_list_max.c $(SORTINGPATH)is_list_min.c \
			$(SORTINGPATH)is_sorted_list.c $(SORTINGPATH)lis_len.c $(SORTINGPATH)lis.c \
			$(SORTINGPATH)max_array.c $(SORTINGPATH)sort_circular_list.c
